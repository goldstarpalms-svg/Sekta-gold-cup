          ...
          <div className="max-w-[760px] mx-auto w-full py-6">
            {messages.length === 0 && !isStreaming && (
              <div className="relative text-center py-16 md:py-20 overflow-hidden">
                {/* soft ambient glow backdrop, Claude-style calm */}
                <div className="pointer-events-none absolute inset-0 -z-10 flex items-start justify-center">
                  <div className="w-[520px] h-[420px] rounded-full bg-[#FFC700]/8 blur-[110px]" />
                </div>

                <span className="block text-[26px] text-[#FFC700] mb-3">✦</span>

                <h1 className="font-serif text-[30px] md:text-[36px] leading-[1.25] font-medium tracking-tight text-[#F2EEE4]">
                  How can Sekta Gold help you today?
                </h1>

                {/* Composer-adjacent quick prompt, Claude-style pill row ("mode tabs") */}
                <div className="flex flex-wrap items-center justify-center gap-2 mt-7 max-w-[620px] mx-auto">
                  {[
                    ...
                    <button
                      ...
                      className="group flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-transparent border border-[#232325] hover:border-[#FFC700]/40 hover:bg-[#141415] text-[13px] text-zinc-300 hover:text-white transition"
                    >
                ...
                <p className="text-zinc-500 mt-6 text-[13px] max-w-[440px] mx-auto">
                  Powered by {selectedAgent.name.toLowerCase()} and 7 other specialists — code, research, design, data, and more, all in one box.
                </p>
